...
func EventIndexCallback(orm *gorm.DB, swapTargetRemovedEventTracker SwapTargetRemovedEventTracker, tokenWithdrawnEventTracker TokenWithdrawnEventTracker, ethWithdrawnEventTracker EthWithdrawnEventTracker, swapTargetAddedEventTracker SwapTargetAddedEventTracker, txLogs []ethrpc.Log, ethClient *EthBlockChainRPCWithRetry) error {
	...
	go func() {
		...
		for true {
			...
			if len(topicsInterestedIn) > 0 {
				...
				err := EventIndexCallback(orm, swapTargetRemovedEventTracker, tokenWithdrawnEventTracker, ethWithdrawnEventTracker, swapTargetAddedEventTracker, receiptLogs.receipts, ethRPCClient)
				if err != nil {
